    ...
    <body>
        ...
        <div id="example" class="container">
            ...
            <section class="well">
                ...
                <?php if ($message == 2) { ?>
                    <p class="message icon-speech blue-gradient small-margin-bottom">
                        <a href="#" title="Hide message" class="close"></a> 
                        Member Details Insertion Unsuccessful. Please submit the details again.
                    </p>
                <?php } ?>
                ...
                <?php if ($message == 1) { ?>
                    <p class="message icon-speech red-gradient small-margin-bottom">
                        <a href="#" title="Hide message" class="close"></a> 
                        Member Details Insertion Successful. 
                    </p>
                <?php } ?> 
                <p>


                <form name="insert_form" id="member_form" method="post" action="<?php echo site_url(); ?>/member_details_con/member_data_set" enctype="multipart/form-data">
                    <div class="form-horizontal form-widgets col-sm-12">
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="name">Member Name</label>
                            <div class="col-sm-10">
                                <input id="name" name="name" style="width: 55%;"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-6">
                                <input  name="dob" style="width: 50%;" id="datepicker"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-6">
                                <input  name="phoneNo1" id="tel1" style="width: 50%;" />
                            </div>
                        </div>
                    ...
                    <div class="buttons-wrap">                                           
                        <input class="k-button k-state-default" type="submit" name="submit" value="Submit Details" />
                    </div>
                    </ form>
            </section>
