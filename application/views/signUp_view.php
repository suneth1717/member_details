    ...
    <body>
            ...
            <section class="well">
                ...
                <?php if ($message == 2) { ?>
                    <p class="message icon-speech blue-gradient small-margin-bottom">
                        ...
                        Sign Up Unsuccessful. Please submit the details again.
                    </p>
                <?php } ?>
                ...
                <p>
                    ...
                    <?php echo form_open('login/signup_data_save'); ?>
                <div class="form-horizontal form-widgets col-sm-12">
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="username">User Name</label>
                        <div class="col-sm-10">
                            <input id="username" type="text" onchange="check_user_exist()" name="username" style="width: 35%;"/><span id="uname" ></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="password">Password</label>
                        <div class="col-sm-10">
                            <input id="password" type="password" name="password" style="width: 35%;"/><span id="pw" ></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="password">Re-enter Password</label>
                        <div class="col-sm-10">
                            <input id="repassword" onchange="validate_password()" type="password" name="repassword" style="width: 35%;"/>
                        </div>
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="buttons-wrap">                                           
                    <input class="k-button k-state-default" type="submit" name="submit" value="Sign Up" />
                </div>
                </ form>
            </section>
        ...
        <script>
            function check_user_exist() {
                ...
                $.ajax({
                    type: "POST",
                    url: site_path + "/login/check_username",
                    ...
                    success: function(json_data)
                    {
                        ...
                        //alert(output);
                        if (output == false) {
                            document.getElementById("uname").innerHTML = "User name already exist.Enter different user name.";
                            document.getElementById("username").focus();
                        }
                        else {
                            document.getElementById("uname").innerHTML = "User name available.";
                        }
