    ...
    <body>
        ...
        <div id="example" class="container">
            ...
            <section class="well">
                ...
                <form name="insert_form" id="member_form" method="post" action="<?php echo site_url(); ?>/member_details_con/deleteOldMember" enctype="multipart/form-data">
                    ...
                    <div class="form-horizontal form-widgets col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="name" name="name" disabled="true" value="<?php echo $result[0]['member_name']; ?>" style="width: 55%;"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-6">
                                <input  name="dob" style="width: 50%;" disabled="true" value="<?php echo $result[0]['birthday']; ?>" id="datepicker"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-6">
                                <input  name="phoneNo1" disabled="true" value="<?php echo $result[0]['phoneno_m']; ?>" id="tel1" style="width: 50%;" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-6">
                                <input  name="phoneNo2" id="tel2" disabled="true" value="<?php echo $result[0]['phoneno_m2']; ?>" onchange="validate_tel2()" style="width: 50%;" /><span id="telno2" ></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="phoneNo3">Phone Number Home</label>
                            <div class="col-sm-8 col-md-6">
                                <input name="phoneNo3" id="tel3" disabled="true" value="<?php echo $result[0]['phoneno_h']; ?>" onchange="validate_tel3()" style="width: 50%;" /><span id="telno3" ></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="address">Personal Address</label>
                            <div class="col-sm-10">
                                <input  name="address" disabled="true" value="<?php echo $result[0]['personal_address']; ?>" style="width: 55%;" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="email">Email Address</label>
                            <div class="col-sm-8 col-md-6">
                                <input  name="email" disabled="true" value="<?php echo $result[0]['email']; ?>" style="width: 50%;"  />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="skype">Skype ID</label>
                            <div class="col-sm-8 col-md-6">
                                <input  name="skype" disabled="true" value="<?php echo $result[0]['skype_id']; ?>" style="width: 50%;" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="profession">Profession</label>
                            <div class="col-sm-8 col-md-6">
                                <input  name="profession" disabled="true" value="<?php echo $result[0]['profession']; ?>" style="width: 50%;" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="company">Company Name</label>
                            <div class="col-sm-8 col-md-6">
                                <input  name="company" disabled="true" value="<?php echo $result[0]['company_name']; ?>" style="width: 50%;" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="companyAdd">Company Address</label>
                            <div class="col-sm-10">
                                <input  name="companyAdd" disabled="true" value="<?php echo $result[0]['company_address']; ?>" style="width: 55%;" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="fax">Fax Number</label>
                            <div class="col-sm-8 col-md-6">
                                <input  name="fax" disabled="true" value="<?php echo $result[0]['fax_no']; ?>" style="width: 50%;" />
                            </div>
                        </div>
                    ...
                    <div class="buttons-wrap">                                           
                        <input class="k-button k-state-default" type="submit" name="submit" value="Delete the member" />
                    </div>
                    </ form>
            </section>
