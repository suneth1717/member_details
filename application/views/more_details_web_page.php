...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/css/jquery-ui-1.11.1/jquery.dataTables.min.css">
    ...
    <body>
        ...
        <div id="example" class="container">
            ...
            <section  class="well">
                 <table id="myTable" class="display table" width="100%" border='1'>
                     <thead hidden>
                         <th></th>
                         <th></th>
                         <th></th>
                      ...
                      <tbody>
                        ...
                        foreach ($result as $row) {
                            ...
                            echo'</tr>';
                            echo'<tr>';
                            echo'<td><b>'. "Birth Day" . '<b></td>';
                            echo'<td>' . $row['birthday'] . '</td>';
                            echo'</tr>';
                            echo'<tr>';
                            echo'<td><b>'. "Phone Number 1 " . '<b></td>';
                            echo'<td>' . $row['phoneno_m'] . '</td>';
                            echo'</tr>';
                            echo'<tr>';
                            echo'<td><b>'. "Phone Number 2" . '<b></td>';
                            echo'<td>' . $row['phoneno_m2'] . '</td>';
                            echo'</tr>';
                            echo'<tr>';
                            echo'<td><b>'. "Phone Number Home" . '<b></td>';
                            ...
                            echo'</tr>';
                            echo'<tr>';
                            echo'<td><b>'. "company address" . '<b></td>';
                            echo'<td>' . $row['company_address'] . '</td>';
                            echo'</tr>';
                            echo'<tr>';
                            echo'<td><b>'. "fax number" . '<b></td>';
        ...
        <script language="javascript" type="text/javascript" src="<?php echo base_url() ?>assets/js/jquery-ui-1.11.1/angular.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo base_url() ?>assets/js/jquery-ui-1.11.1/kendo.all.min.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo base_url() ?>assets/js/jquery-ui-1.11.1/kendo.timezones.min.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo base_url() ?>assets/js/jquery-ui-1.11.1/bootstrap.min.js"></script>
        <script language="javascript" type="text/javascript" src="<?php echo base_url() ?>assets/js/jquery-ui-1.11.1/theme-chooser.js"></script>
