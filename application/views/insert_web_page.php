...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/js/jquery-ui-1.11.1/jquery.dataTables.css">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/js/jquery-ui-1.11.1/jquery-ui.css">
                 ...
                 <?php echo form_open('member_details_con/show_member_details') ?>
                    <div class="form-horizontal form-widgets col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-6">
                                <input  name="name" style="width: 55%;" />
                            </div>
                        </div>                       
                    </div>
                    <div class="clearfix"></div>
                    <div class="buttons-wrap">
                        <input class="k-button k-state-default" type="submit" name="submit" value="Search" />
                    </div>
                    </ form>
            </section>
